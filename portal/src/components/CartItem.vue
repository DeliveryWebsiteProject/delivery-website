    ...
    <div class="item">
        ...
        <div class="content">
            ...
            <div class="bottom-section">
                <div class="bottom-section_price"><b>{{ price }}</b></div>
                <div class="bottom-section_counter">
                    <img @click="minusCounter"
                        :class="blocked ? 'bottom-section_counter_button_block' : 'bottom-section_counter_button_minus'"
                        :src="getIcon('minus')" />
                    <p class="bottom-section_counter_text">{{ counter }}</p>
