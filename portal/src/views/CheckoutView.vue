        ...
        <div class="cards">
            <div class="cards_west">
                <div class="content_title">
                    ...
                    <p class="content_title_subtitle">Complete seu pedido fornecendo os detalhes de pagamento</p>
                </div>
                <div class="delivery_options">
                    <div class="option_entrega" v-for="(option, index) in deliveryOptions" :key="index">
                        <input type="radio" :id="option.id" :name="option.name" :value="option.value"
                ...
                <div class="pagamento card">
                    <div class="content_pagamento">
                        <div class="content_pagamento_options">
                            <div class="option_payment" v-for="(option, index) in paymentOptions" :key="index">
                                <input type="radio" :id="option.id" :name="option.name" :value="option.value"
            ...
            <div class="summary card">
                ...
                <ul class="summary_orders_list">
                    <li class="summary_order_item" v-for="(order, index) in orders" :key="index">
                        <span class="summary_order_item_quantity">{{ order.quantity }}</span>
                        <span class="summary_order_item_name">{{ order.itemName }}</span>
                    </li>
                </ul>
                <hr>
                <div class="summary_subtotal_line">
                    <p class="summary_subtotal_line_title">Entrega <span class="summary_subtotal_line_value">R$00,00</span>
                    </p>
                    <p class="summary_subtotal_line_title">Subtotal <span class="summary_subtotal_line_value">R$00,00</span>
                    </p>
                    <p class="summary_total_line_title">Valor total <span class="summary_total_line_value">R$00,00</span>
                    </p>
                </div>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            deliveryOptions: [
                { id: 'delivery', name: 'delivery', value: 'delivery', label: 'delivery' },
                { id: 'balcao', name: 'balcao', value: 'balcao', label: 'balcão' },
            ],
            paymentOptions: [
                { id: 'pix', name: 'pix', value: 'pix', label: 'Pix' },
                { id: 'credito', name: 'credito', value: 'credito', label: 'Cartão crédito' },
                { id: 'debito', name: 'debito', value: 'debito', label: 'Cartão débito' },
                { id: 'dinheiro', name: 'dinheiro', value: 'dinheiro', label: 'Dinheiro' },
            ],
            orders: [
